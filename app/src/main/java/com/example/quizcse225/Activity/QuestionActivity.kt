...
import com.example.quizcse225.Adapter.QuestionAdapter
...
import com.example.quizcse225.databinding.ViewholderQuestionBinding
...
class QuestionActivity : AppCompatActivity(), QuestionAdapter.score {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val receivedList=intent.getParcelableArrayListExtra<QuestionModel>("list")!!.toMutableList()
        binding.apply {
            ...
            rightArrow.setOnClickListener{
                ...
                questionNumtxt.text="Question " + progressBar.progress +"/10"
                questionTxt.text=receivedList[position].question
